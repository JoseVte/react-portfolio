...
const messages = {
    en: {
        translation: {
            ...
            'layouts.description': 'I’m Jose Vicente, a web developer with extensive experience in design, development, and deployment of web applications.',
            'layouts.description-extended': 'Expert in languages such as PHP, Javascript and HTML+CSS and frameworks such as Laravel, Vue and Tailwind. Passionate about staying up-to-date with the latest trends and technologies in the field of web development.',
            ...
            'about.paragraph-1': 'I am Jose Vicente Orts Romero, a passionate software developer with extensive experience in the field of technology. Over the course of more than 10 years, I have had the opportunity to work on various projects.',
            'about.paragraph-2': 'My academic background in computer engineering has laid a strong foundation for my professional career. I have specialized in web development, using modern languages and technologies such as Vue, Laravel or React. I thrive on taking on new challenges and seeking creative and efficient solutions to overcome them.',
    ...
    es: {
        translation: {
            ...
            'layouts.description': 'Soy Jose Vicente, un desarrollador web con una extensa experiencia en el diseño, desarrollo y despliegue de aplicaciones web.',
            'layouts.description-extended': 'Experto en lenguajes como PHP, Javascript y HTML+CSS y frameworks como Laravel, Vue y Tailwind. Apasionado por estar al día con las últimas tendencias y tecnologías en el campo del desarrollo web.',
            ...
            'about.paragraph-1': 'Soy Jose Vicente Orts Romero, un apasionado desarrollador de software con amplia experiencia en el campo de la tecnología. A lo largo de más de 10 años, he tenido la oportunidad de trabajar en varios proyectos.',
            'about.paragraph-2': 'Mi formación académica en ingeniería informática ha sentado una base sólida para mi carrera profesional. Me he especializado en desarrollo web, utilizando lenguajes y tecnologías modernas como Vue, Laravel o React. Me gusta asumir nuevos desafíos y buscar soluciones creativas y eficientes para superarlos.',
