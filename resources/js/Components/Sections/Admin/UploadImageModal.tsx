        ...
        <Modal show={true} onClose={closeModal}>
            ...
            <Modal.Body>
                ...
                {previewUrl && (
                    <div id="preview" className="mb-5">
                        <div
                            className="relative aspect-[9/10] h-48 mx-auto flex-none overflow-hidden rounded-xl bg-zinc-100 dark:bg-zinc-800 sm:rounded-2xl">
                            <img src={previewUrl} className="absolute inset-0 h-full w-full object-cover !filter-none"
                                 alt="Preview"/>
                        </div>
                    </div>
                )}
                ...
                <label>
                    <span
                        className={`block mb-2 text-sm font-medium ` + (errors.file ? 'text-red-700 dark:text-red-500' : 'text-gray-900 dark:text-white')}>File</span>
                </label>

                <FileInput required={true} onChange={(e) => {
            ...
            <Modal.Footer>
                ...
                <div className="flex justify-between">
                    ...
                    <Button
                        color="green" onClick={submitForm}>
                        Upload
                    </Button>
                </div>
            </Modal.Footer>
